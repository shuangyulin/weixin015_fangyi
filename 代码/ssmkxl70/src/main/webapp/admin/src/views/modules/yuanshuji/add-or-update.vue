          ...
          <el-form-item class="input" label="密码" prop="mima">
              <el-input v-model="ruleForm.mima" 
                placeholder="密码" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="院书记姓名" prop="yuanshujixingming">
          <el-input v-model="ruleForm.yuanshujixingming" 
              placeholder="院书记姓名" clearable  :readonly="ro.yuanshujixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="院书记姓名" prop="yuanshujixingming">
              <el-input v-model="ruleForm.yuanshujixingming" 
...
export default {
            ...
            ruleForm: {
                	        yuanshujigonghao: '',
                                ...
                                xueyuanOptions: [],
                                                                                          rules: {
                  yuanshujigonghao: [
                            { required: true, message: '院书记工号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  mima: [
                            { required: true, message: '密码不能为空', trigger: 'blur' },
                                    	                                                              ],
                  yuanshujixingming: [
                            { required: true, message: '院书记姓名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xingbie: [
                                    	                                                              ],
                  xueyuan: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yuanshuji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuanshujiCrossAddOrUpdateFlag = false;
                  this.parent.search();
