  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="年级" prop="nianji">
              <el-input v-model="ruleForm.nianji" 
                placeholder="年级" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否住宿" prop="shifouzhusu">
          <el-select v-model="ruleForm.shifouzhusu" placeholder="请选择是否住宿">
            <el-option
                v-for="(item,index) in shifouzhusuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否住宿" prop="shifouzhusu">
	      <el-input v-model="ruleForm.shifouzhusu"
                placeholder="是否住宿" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="宿舍栋" prop="sushedong">
          <el-input v-model="ruleForm.sushedong" 
              placeholder="宿舍栋" clearable  :readonly="ro.sushedong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="宿舍栋" prop="sushedong">
              <el-input v-model="ruleForm.sushedong" 
                placeholder="宿舍栋" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.nianji = true;
            continue;
	            	            ...
	            	            if(o=='shifouzhusu'){
            this.ruleForm.shifouzhusu = obj[o];
	    this.ro.shifouzhusu = true;
            continue;
          }
	            	            if(o=='sushedong'){
            this.ruleForm.sushedong = obj[o];
	    this.ro.sushedong = true;
            continue;
          }
	            	            if(o=='fangjianhao'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                            ...
                                                                            this.shifouzhusuOptions = "是,否".split(',')
                                                                                                                                        },
                                                                                                                // 多级联动参数
                                                                                                                                              info(id) {
      this.$http({
        url: `xueshengjibenxinxi/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xueshengjibenxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xueshengjibenxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
