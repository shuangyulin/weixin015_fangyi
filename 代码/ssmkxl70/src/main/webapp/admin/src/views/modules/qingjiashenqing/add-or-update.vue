  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="学院" prop="xueyuan">
              <el-input v-model="ruleForm.xueyuan" 
                placeholder="学院" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="请假时长" prop="qingjiashizhang">
          <el-select v-model="ruleForm.qingjiashizhang" placeholder="请选择请假时长">
            <el-option
                v-for="(item,index) in qingjiashizhangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="请假时长" prop="qingjiashizhang">
	      <el-input v-model="ruleForm.qingjiashizhang"
                placeholder="请假时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
